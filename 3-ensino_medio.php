...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>3º Ensino Médio | Estudos Produtivos </title>
    ...
    <body>
        ...
        <header id="home"  aria-label="seção header da pagina 3º Ensino Médio">
        ...
        <div class="container" style="background-image: url('assets/imgs/Background_cadastro.png');">

            <section class="banner" aria-label="seção da página boas vinada: Boa!!! você é mestre(a), chegou no 3 nível do encino médio e último está na hora de revisar o conteúdos passados, e aprender novos conceitos, e espero que tenha aproveitado ao máximo o encino médio!">

                <div class="banner-text">

                    <h1 class="digitando">   3º Ensino Médio</h1>

                    <p>Boa!!! você é mestre(a), chegou no 3 nível do encino médio e último está na hora de revisar o conteúdos passados, e aprender novos conceitos, e espero que tenha aproveitado ao máximo o encino médio!</p>
                    
                    <a href="#diciplinas" class="btn">Nível 3</a>
