...
<html lang="pt-br">
    ...
    <head>
        ...
        <title>2º Ensino Médio | Estudos Produtivos </title>
    ...
    <body>
        ...
        <header id="home"  aria-label="seção header da pagina 2º Ensino Médio">
        ...
        <div class="container" style="background-image: url('assets/imgs/Background_login.png');">
            ...
            <section class="banner" aria-label="seção da página boas vinada: Boa!!! você é fera, chegou no 2 nível do encino médio está na hora de revisar o conteúdo passado, e aprender novos conceitos!">

                <div class="banner-text">

                    <h1 class="digitando">   2º Ensino Médio</h1>

                    <p>Boa!!! você é fera, chegou no 2 nível do encino médio está na hora de revisar o conteúdo passado, e aprender novos conceitos!</p>
                    
                    <a href="#diciplinas" class="btn">Nível 2</a>
